...
describe("entities", () => {
  ...
  describe('getFirstArtist()', () => {
    it("should return first item in results array", async () => {        
      ...
      const data = await entities.getFirstArtist('term=hello', httpClient(getFake))
  ...
  describe("getAlbumsByArtistId", () => {    
    it("should return an array of albums", async () => {     
      ...
      const data = await entities.getAlbumsByArtistId('12345', httpClient(getFake))
